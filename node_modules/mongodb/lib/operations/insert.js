...
class InsertOneOperation extends InsertOperation {
    ...
    async execute(server, session) {
        try {
            ...
            // Check if there are write errors and throw the first one
            if (res.writeErrors) {
                // It should ideally be a WriteError, but we can't change it due to error hierarchy
                throw new error_1.MongoServerError(res.writeErrors[0]);
            }
    
            // If no errors occurred, return information about the operation's success
            return {
            ...
            console.error("An error occurred in the 'execute' method:", error);
